...
Those libraries provide many additional features and optimizations, but underneath, they're all built around the same fundamental concept: when something changes, notify everyone who's interested.
